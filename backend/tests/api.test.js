...
const testGame = {
    ...
    difficulty: 'easy',
    cards: [
        { id: 'laughing_1', pairId: 'laughing', emoji: '😂', name: 'Laughing', category: 'classic' },
        { id: 'laughing_2', pairId: 'laughing', emoji: '😂', name: 'Laughing', category: 'classic' }
    ]
};
        ...
        describe('POST /api/game/match', () => {
            test('should process a successful match', async () => {
                const mockGameSession = {
                    ...
                    username: testUser.username,
                    cards: [
                        { id: 'laughing_1', pairId: 'laughing', emoji: '😂', isMatched: false },
                        { id: 'laughing_2', pairId: 'laughing', emoji: '😂', isMatched: false }
                    ],
                    score: 0,
                    moves: 0,
                    matches: [],
    ...
    describe('🏆 Leaderboard', () => {
        ...
        describe('GET /api/leaderboard/fresh', () => {
            test('should return fresh leaderboard data', async () => {
                ...
                redisClient.keys.mockResolvedValue(['leaderboard:cache1', 'leaderboard:cache2']);
                redisClient.del.mockResolvedValue(1);
