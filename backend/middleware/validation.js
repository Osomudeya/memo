...
const schemas = {
    ...
    gameStart: Joi.object({
        ...
        categories: Joi.array()
            .items(Joi.string().valid('classic', 'food', 'space', 'fantasy', 'tech', 'love', 'thoughtful', 'silly', 'sassy', 'spooky', 'nature', 'music', 'cool', 'celebration', 'mystery', 'action', 'adventure', 'hot', 'energy', 'luxury', 'achievement'))
            .max(10)
            .optional()
            .messages({
